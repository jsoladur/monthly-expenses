...
| --- | --- | --- |
| `prds/GLOBAL.md` | **PRD — source of truth for BEHAVIOR.** Constraints C1–C21, money rules §7, use cases UC-01…UC-23, test scenarios §15, copy snippets §19. | Before ANY feature work. |
